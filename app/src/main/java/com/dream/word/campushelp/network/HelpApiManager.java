...
import com.dream.word.campushelp.network.Interceptor.ResponseInterceptor;
import com.dream.word.campushelp.network.bean.DataBean;
...
public class HelpApiManager {
    ...
    public static HelpApiManager getInstance() {
        if (Instant == null) {
