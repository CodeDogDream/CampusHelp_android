...
public class MyHelpInfoFragment extends BaseFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        sendRequestForMyHelpInfo();
    }

    private void sendRequestForMyHelpInfo() {
        ...
        HelpApiManager.getInstance().sendRequest(ss, HttpData.GET_ID_HELP_INFO, RuntimeInfo.getInstance().uid);
    }
}
